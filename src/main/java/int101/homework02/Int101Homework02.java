...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
        System.out.println("testString(\"Hello World\") = " + testString("Hello World"));
        System.out.println("testPositive(1) = " + testPositive(2));
        System.out.println("computeIsbn10(123456789) = " + computeIsbn10(963448531));
       /*
